...
const UserGroupDiv = ( props ) => {
    ...
    const groupUsers = [
      ...
      const createSlides = groupUsers.map((user) => {
        return { image: user.photo, title: user.name, description: user.igName, clickEvent: sliderClick };
    });
  ...
  return (
    <div className='group-slider'>
        ...
        <p className='group-slider-capacity'> { group.members.length} / { group.maxMembers }</p>
